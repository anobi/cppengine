...
void Rendering::GL::GLRenderer::Shutdown()
{
}

bool Rendering::GL::GLRenderer::Init()
{
	return true;
}

void Rendering::GL::GLRenderer::Render(std::shared_ptr<Camera> camera, std::shared_ptr<Shader> shader)
{
	shader->Bind();
	//
